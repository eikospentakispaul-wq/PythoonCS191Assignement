...
class PartyGuest:
    ...
    def __init__(self, name, surname, drink_preference, food_preference,club_price,cake_portion):
        ...
        self._drink_preference = drink_preference
        self._food_preference = food_preference
        self._club_price = club_price
        self._cake_portion = cake_portion
    ...
    @property
    def drink_preference(self):
        return self._drink_preference
    ...
    @property
    def club_price(self):
        return self._club_price

    @property
    def cake_portion(self):
        return self._cake_portion

    @cake_portion.setter
    def cake_portion(self, value):
        self._cake_portion= value
